...
const (
	...
	BookService_GetBooksByUser_FullMethodName = "/BookService/GetBooksByUser"
	BookService_BuyBook_FullMethodName        = "/BookService/BuyBook"
	BookService_BooksCount_FullMethodName     = "/BookService/BooksCount"
)
...
type BookServiceClient interface {
	...
	GetBooksByUser(ctx context.Context, in *GetBooksByUserRequest, opts ...grpc.CallOption) (*GetBooksByUserResponse, error)
	BuyBook(ctx context.Context, in *BuyBookRequest, opts ...grpc.CallOption) (*BuyBookResponse, error)
	BooksCount(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BooksCountResponse, error)
}
...
func (c *bookServiceClient) GetBooksByUser(ctx context.Context, in *GetBooksByUserRequest, opts ...grpc.CallOption) (*GetBooksByUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBooksByUserResponse)
	err := c.cc.Invoke(ctx, BookService_GetBooksByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) BuyBook(ctx context.Context, in *BuyBookRequest, opts ...grpc.CallOption) (*BuyBookResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BuyBookResponse)
	err := c.cc.Invoke(ctx, BookService_BuyBook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) BooksCount(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BooksCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BooksCountResponse)
	err := c.cc.Invoke(ctx, BookService_BooksCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	GetBooksByUser(context.Context, *GetBooksByUserRequest) (*GetBooksByUserResponse, error)
	BuyBook(context.Context, *BuyBookRequest) (*BuyBookResponse, error)
	BooksCount(context.Context, *Void) (*BooksCountResponse, error)
...
func (UnimplementedBookServiceServer) GetBooksByUser(context.Context, *GetBooksByUserRequest) (*GetBooksByUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBooksByUser not implemented")
}
func (UnimplementedBookServiceServer) BuyBook(context.Context, *BuyBookRequest) (*BuyBookResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuyBook not implemented")
}
func (UnimplementedBookServiceServer) BooksCount(context.Context, *Void) (*BooksCountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BooksCount not implemented")
}
...
func _BookService_GetBooksByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBooksByUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).GetBooksByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_GetBooksByUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetBooksByUser(ctx, req.(*GetBooksByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookService_BuyBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BuyBookRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).BuyBook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_BuyBook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).BuyBook(ctx, req.(*BuyBookRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookService_BooksCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).BooksCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_BooksCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).BooksCount(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBooksByUser",
			Handler:    _BookService_GetBooksByUser_Handler,
		},
		{
			MethodName: "BuyBook",
			Handler:    _BookService_BuyBook_Handler,
		},
		{
			MethodName: "BooksCount",
			Handler:    _BookService_BooksCount_Handler,
		},
	},
